                        ...
                        <tbody id="product-table-body">
                            <?php foreach ($products as $product): ?>
                                <tr data-category="<?= $product['category_name']; ?>"
                                    ...
                                    <td class="py-3 px-12 text-xl"><?php echo $product['stock_quantity']; ?></td>
                                    <td class="py-3 px-8 text-xl"><?php echo $product['category_name']; ?></td>
                                    <td class="flex py-3 px-6 text-xl justify-center relative">
                                        ...
                                        <div id="actionDropdown<?= $product['product_id'] ?>" class="icons flex absolute right-4 w-26 bg-white shadow-lg rounded hidden">
                                            <a href="/productsList/edit?id=<?= $product["product_id"] ?>" class="flex items-center px-2 py-1 text-sm hover:bg-gray-100">
                                            ...
                                            <a href="/productsList/detail?id=<?= htmlspecialchars($product["product_id"]) ?>" class="flex items-center px-2 py-1 text-sm hover:bg-gray-100">
                                    ...
                                    <div id="deleteProductModal<?= $product['product_id'] ?>" 
                                            ...
                                            <div class="bg-white p-6 rounded-lg shadow-lg w-100">
                                                <h2 class="text-3xl text-green-500 flex justify-center">Delete Product</h2>
                                                <p class="text-xl mt-4">Are you sure you want to delete this product?</p>
                                                ...
                                                <div class="mt-6 flex justify-end space-x-2">
                                                    ...
                                                    <form action="/productsList/delete?id=<?= $product['product_id'] ?>" method="POST">
